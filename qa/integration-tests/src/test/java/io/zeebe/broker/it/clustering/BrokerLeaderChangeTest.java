...
public class BrokerLeaderChangeTest {
  ...
  public void shouldBecomeFollowerAfterRestartLeaderChange() {
    ...
    LogstreamConfig.getConfig(
        "", 1); // FIXME: remove, this is so I don't have to change the stupid unused dep
    Atomix.builder(); // FIXME: remove, this is so I don't have to change the stupid unused dep
  }
  //
  //  @Test
  ...
  //        .getServiceContainer()
  //        .createService(ServiceName.newServiceName("test-leader-election", Void.class), () ->
  // null)
  //        .dependency(
